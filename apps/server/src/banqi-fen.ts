// Banqi UCI FEN encoder — the redaction boundary for the MistyBanqi UCI engine
// (`banqi-engine`, "our own hw3", in ~/projects/mistboard-engine). The Banqi analogue
// of jieqi-fen.ts: it takes canonical game state and produces exactly what the engine

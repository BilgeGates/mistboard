...
// replay fixture game 0 (DUAL_CHESS_REPLAY_GAMES[0]), which White wins by the
// race, the king reaching the eighth rank on move 44 (f7f8). The move list is
// replayed through the real Crossroads Chess kernel by dual-chess-replay.ts; no
// precomputed board images are shipped.

export const DUAL_CHESS_SAMPLE_GAME = {

...
const baseAnnouncements: Announcement[] = [
  ...
  },
  {
    ...
    body: 'Prefer a slower game? Post or accept a days-per-move seek from the homepage lobby, or send a friend a challenge link and play at your own pace.',
    href: '/',
    cta: 'Find a game',
  },
  {
    ...
    body: 'Set up any position on a free analysis board for all eight games, with a local engine eval, FEN and move import, and server analysis with accuracy grading for finished games.',
    href: '/analysis',
    cta: 'Open the board',
  },
  {

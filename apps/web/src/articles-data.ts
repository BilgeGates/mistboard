    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: 'paragraph', text: 'Rated may begin in recurring windows instead of staying open 24/7. That is a liquidity and calibration choice: concentrated sessions help players find opponents, and early ratings should come from real games, not empty-queue timing.' },

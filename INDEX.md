...
| `server-ws-dark-xiangqi.ts` | Hidden Dark Xiangqi WebSocket handler: red/black connection handoff, message dispatch, move/abort/resign events, lifecycle timers, and recipient-scoped snapshot/event broadcasts. |
